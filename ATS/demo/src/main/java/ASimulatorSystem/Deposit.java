...
public class Deposit extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent ae) {
        try {
            ...
            Timestamp date = new Timestamp(System.currentTimeMillis()); // Current timestamp
            if (ae.getSource() == b1) {
                if (t1.getText().equals("")) {
                   ...
                   String query = "INSERT INTO bank (pin, date, mode, amount) VALUES (?, ?, ?, ?)";
                    ...
                    PreparedStatement pstmt = con.prepareStatement(query); // Use Connection to create PreparedStatement
